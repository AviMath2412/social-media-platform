...
export function AuthModal({ open, onOpenChange, mode = "login", onModeChange, onSuccess }: AuthModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[425px]">
        ...
        <Tabs defaultValue={mode} value={activeTab} onValueChange={handleTabChange} className="w-full">
          ...
          <TabsContent value="login">
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <Button type="submit" className="w-full bg-violet-500 hover:bg-violet-600" disabled={isLoading}>
